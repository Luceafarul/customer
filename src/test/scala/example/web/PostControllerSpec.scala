...
class PostControllerSpec extends AnyWordSpec
  with Matchers
  ...
  private val route = new Api(customerService, postService).route
  ...
  private val postControllerWithStub = new PostController(postServiceStub)
  private val routeWithStub = new Api(customerServiceStub, postServiceStub).route
